...
for ixA,xA in enumerate(xAs):
    ...
    for i in range(nSrcLong):
        ...
        longRecBFib[startIdxL:nt+startIdxL] = longRecBFib[startIdxL:nt+startIdxL] + sigii_Love(xsrcL, times, f, cL, xB)
        ...
        longRecBFib[startIdxR:nt+startIdxR] = longRecBFib[startIdxR:nt+startIdxR] + sigii_Rayleigh(xsrcR, times, f, cR, xB)
...
plt.savefig(fig+'two-orthogonal-lines')